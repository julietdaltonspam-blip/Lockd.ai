    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end">
          ...
          <div className="relative w-full max-w-lg mx-auto glass border border-zinc-700 rounded-t-2xl animate-slide-up" style={{ height: "70vh" }}>
            <div className="flex items-center justify-between p-4 border-b border-zinc-800">
              ...
              <button onClick={() => setIsOpen(false)} className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center">
              ...
              {messages.map((msg, i) => (
                <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                  <div className={`max-w-[80%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
                    msg.role === "user" ? "bg-purple-600 text-white rounded-br-sm" : "bg-zinc-800 text-zinc-100 rounded-bl-sm"
                  }`}>
                    {msg.content}
                  </div>
                </div>
            ...
            <div className="p-4 border-t border-zinc-800">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-purple-600 flex items-center justify-center disabled:opacity-40"
                >
