...
const FORMATS: { id: OutputFormat; emoji: string; label: string; desc: string; color: string }[] = [
  ...
  { id: "podcast", emoji: "🎙️", label: "Podcast Mode", desc: "Chill lo-fi podcast script with two hosts", color: "#f59e0b" },
              ...
              {SUBJECTS.map(s => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={selected ? "" : "ml-0"}>{s}</span>
                  </button>
                );
              })}
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-bold" style={selected ? { color: f.color } : { color: "#fafafa" }}>
                        {f.label}
                      </p>
        ...
        {step === 3 && (
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-zinc-400 text-sm mb-8">
              Upload anything — a photo of your notes, a PDF, a YouTube link, or just paste some text.
              We'll turn it into something you'll actually want to study.
            </p>
            <div className="grid grid-cols-3 gap-3 mb-8">
              {["📸 Photo", "📄 PDF", "🔗 YouTube", "🎙️ Record", "🎵 Audio", "✍️ Text"].map(i => (
                <div key={i} className="p-3 rounded-xl bg-zinc-900 border border-zinc-800 text-sm text-zinc-300">
                  {i}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-md mx-auto flex gap-3">
          ...
          >
            {saving ? (
              ...
              <>
                {step === 3 ? "Make my first study set" : "Continue"}
                <ArrowRight size={18} />
              </>
            )}
          </button>
